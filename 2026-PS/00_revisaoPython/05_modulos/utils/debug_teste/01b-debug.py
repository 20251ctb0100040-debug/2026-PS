...
# import temperatura não  é usado

from conversores import celsius_para_kelvin, km_para_milhas # modulo conversores não existe
from utils.formatador import formatar_resultado # o modulo ta recebendo coisas extra
